...
public class DialogResizer : TemplatedControl
{
    ...
    public static readonly StyledProperty<ResizeDirection> ResizeDirectionProperty =
        AvaloniaProperty.Register<DialogResizer, ResizeDirection>(
    ...
    {
        ResizeDirectionProperty.Changed.AddClassHandler<DialogResizer, ResizeDirection>((resizer, e) =>
            resizer.OnResizeDirectionChanged(e));
    }
