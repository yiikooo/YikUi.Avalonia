...
public class KeyGestureInput : TemplatedControl, IClearControl, IInnerContentControl
{
    ...
    public static readonly StyledProperty<object?> InnerLeftContentProperty =
        AvaloniaProperty.Register<KeyGestureInput, object?>(
