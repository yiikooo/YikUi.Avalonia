...
public class RangeTrack : Control
{
    ...
    public static readonly StyledProperty<Orientation> OrientationProperty =
        AvaloniaProperty.Register<RangeTrack, Orientation>(
            nameof(Orientation));

    public static readonly StyledProperty<Control?> UpperSectionProperty =
        AvaloniaProperty.Register<RangeTrack, Control?>(
            nameof(UpperSection));

    public static readonly StyledProperty<Control?> LowerSectionProperty =
        AvaloniaProperty.Register<RangeTrack, Control?>(
            nameof(LowerSection));

    public static readonly StyledProperty<Control?> InnerSectionProperty =
        AvaloniaProperty.Register<RangeTrack, Control?>(
            nameof(InnerSection));

    public static readonly StyledProperty<Control?> TrackBackgroundProperty =
        AvaloniaProperty.Register<RangeTrack, Control?>(
    ...
    public static readonly StyledProperty<bool> IsDirectionReversedProperty =
        AvaloniaProperty.Register<RangeTrack, bool>(
    ...
    protected override Size ArrangeOverride(Size finalSize)
    {
        ...
        ComputeSliderLengths(finalSize, vertical, out var lowerButtonLength, out var innerButtonLength,
            out var upperButtonLength,
