...
public partial class ContentDialogDemoViewModel : ObservableObject
{
    ...
    [ObservableProperty] private bool _isCloseIconVisible = true;

    // ── 图标可见性控制 ──────────────────────────────────────────────────
    [ObservableProperty] private bool _isPrimaryIconVisible = true;
    [ObservableProperty] private bool _isSecondaryIconVisible = true;
    ...
    private async Task ShowBasic()
    {
        var dialog = new ContentDialog
        {
            ...
            IsPrimaryButtonIconVisible = IsPrimaryIconVisible,
            IsSecondaryButtonIconVisible = IsSecondaryIconVisible,
            IsCloseButtonIconVisible = IsCloseIconVisible
        };
