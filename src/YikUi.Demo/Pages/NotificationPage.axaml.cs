...
using Notification = YikUi.Controls.Notification;

namespace YikUi.Demo.Pages;

public partial class NotificationPage : UserControl
{
    private YikWindowNotificationManager? _notificationManager;
    ...
    private YikWindowNotificationManager GetNotificationManager()
    {
