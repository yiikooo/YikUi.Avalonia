...
public class ClockTicks : Control
{
    ...
    public static readonly StyledProperty<IBrush?> HourTickForegroundProperty =
        AvaloniaProperty.Register<ClockTicks, IBrush?>(
            nameof(HourTickForeground));

    public static readonly StyledProperty<IBrush?> MinuteTickForegroundProperty =
        AvaloniaProperty.Register<ClockTicks, IBrush?>(
            nameof(MinuteTickForeground));

    public static readonly StyledProperty<double> HourTickLengthProperty =
        AvaloniaProperty.Register<ClockTicks, double>(
            nameof(HourTickLength), 10);

    public static readonly StyledProperty<double> MinuteTickLengthProperty =
        AvaloniaProperty.Register<ClockTicks, double>(
    ...
    public static readonly StyledProperty<double> MinuteTickWidthProperty =
        AvaloniaProperty.Register<ClockTicks, double>(
