...
public class RangeSlider : TemplatedControl
{
    ...
    public static readonly StyledProperty<double> LowerValueProperty =
        RangeTrack.LowerValueProperty.AddOwner<RangeSlider>();

    public static readonly StyledProperty<double> UpperValueProperty =
        RangeTrack.UpperValueProperty.AddOwner<RangeSlider>();
    ...
    public static readonly StyledProperty<Orientation> OrientationProperty =
        RangeTrack.OrientationProperty.AddOwner<RangeSlider>();
    ...
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        ...
        _pointerPressedDisposable =
            this.AddDisposableHandler(PointerPressedEvent, PointerPress, RoutingStrategies.Tunnel);
        _pointerReleasedDisposable =
            this.AddDisposableHandler(PointerReleasedEvent, PointerRelease, RoutingStrategies.Tunnel);
    }
    ...
    private Thumb? GetThumbByPoint(PointerPoint point)
    {
        ...
        var lowerThumbPosition =
            isHorizontal ? _track?.LowerThumb?.Bounds.Center.X : _track?.LowerThumb?.Bounds.Center.Y;
        var upperThumbPosition =
            isHorizontal ? _track?.UpperThumb?.Bounds.Center.X : _track?.UpperThumb?.Bounds.Center.Y;
