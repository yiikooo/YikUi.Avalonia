...
public class Marquee : ContentControl
{
    ...
    private (double top, double left)? UpdateLocation(LayoutValues values)
    {
        ...
        {
            Direction.Up or Direction.Down => GetHorizontalOffset(values.Bounds, values.PresenterSize,
        ...
        var verticalOffset = values.Direction switch
        {
            ...
            Direction.Left or Direction.Right => GetVerticalOffset(values.Bounds, values.PresenterSize,
