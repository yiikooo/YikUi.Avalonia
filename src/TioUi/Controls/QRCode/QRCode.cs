            ...
            for (var x = 0; x < 3; x++)
            {
                ...
                geometry.Figures!.Add(new PathFigure
                {
                    ...
                    [
                        new ArcSegment()
                        {
                            SweepDirection = SweepDirection.Clockwise, Size = arcSize,
                            Point = new Point(markerBounds.Left + arcSize.Width, markerBounds.Top)
                        },
                        new LineSegment() { Point = new Point(markerBounds.Right - arcSize.Width, markerBounds.Top) },
                        new ArcSegment()
                        {
                            SweepDirection = SweepDirection.Clockwise, Size = arcSize,
                            Point = new Point(markerBounds.Right, markerBounds.Top + arcSize.Height)
                        },
                        new LineSegment()
                        ...
                        {
                            SweepDirection = SweepDirection.Clockwise, Size = arcSize,
                            Point = new Point(markerBounds.Right - arcSize.Width, markerBounds.Bottom)
                        },
                        new LineSegment() { Point = new Point(markerBounds.Left + arcSize.Width, markerBounds.Bottom) },
                        new ArcSegment()
                        {
                            SweepDirection = SweepDirection.Clockwise, Size = arcSize,
                            Point = new Point(markerBounds.Left, markerBounds.Bottom - arcSize.Height)
                        },
