...
public static class RoutedEventExtension
{
    ...
    {
        foreach (var t in controls) t?.AddHandler(routedEvent, handler);
    }
    ...
    public static void AddHandler<TArgs>(
        ...
        where TArgs : RoutedEventArgs
    {
        foreach (var t in controls) t?.AddHandler(routedEvent, handler, strategies, handledEventsToo);
    }
    ...
    public static void RemoveHandler<TArgs>(
        ...
        where TArgs : RoutedEventArgs
    {
        foreach (var t in controls) t?.RemoveHandler(routedEvent, handler);
    }
